<%-- 
    Document   : ureg
    Created on : May 19, 2017, 5:09:27 PM
    Author     : java3
--%>
...
<center><h2 style="color: #e60498">DATA USER REGISTRATION</h2></center>
<!-- ####################################################################################################### -->
...
<p>
          <select style="width: 200px;height: 25px;color: #A5066D" name="ap" id="email"  >
            ...
            <label style="font-size: 21px;color: whitesmoke;font-style: italic" for="gender">File Access Attribute</label>
          </p>
            <p>
          <select style="width: 200px;height: 25px;color: #A5066D" name="ap1" id="email"  >
                           <option value="-1">Choose </option>
                                        <option value="CSE">CSE</option>
                                        <option value="IT">IT</option>
                                        <option value="ECE">ECE</option>
