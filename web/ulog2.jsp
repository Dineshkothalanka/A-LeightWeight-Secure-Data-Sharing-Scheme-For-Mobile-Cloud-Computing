<%-- 
    Document   : ulog2
    Created on : May 23, 2017, 5:30:10 PM
    Author     : java3
--%>
...
<center><h2 style="color: #e60498">VERIFY</h2></center>
<!-- ####################################################################################################### -->
<div class="wrapper col4">
  <div id="featured_intro">
    <div class="fl_left">
        <img style="width: 400px;height: 400px" src="images/carousel/veri.jpg" alt="" />
    </div>
    <div class="fl_right">
        
     <div id="respond">
        <form action="ulog3.jsp" method="post">
          <p>              
              <input style="width: 200px;height: 22px;" type="text" name="name" id="name" value="" /> &nbsp;&nbsp;
            <label style="font-size: 21px;color: whitesmoke;font-style: italic"for="name">Secret Code</label>
          </p><br>
